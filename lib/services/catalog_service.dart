...
class CatalogService {
  ...
  final List<Subject> _mockSubjects = [
    Subject(
      id: 'ca_foundation_law',
      title: 'Business Laws',
      category: 'CA',
      level: 'Foundation',
      scheme: 'New Scheme 2024+',
      description: 'Indian Regulatory Framework, Sale of Goods Act, Partnership Act, and Companies Act.',
      order: 1,
      createdAt: DateTime(2026, 9, 6),
      updatedAt: DateTime(2026, 9, 6),
    ),
    Subject(
      id: 'ca_foundation_acc',
      title: 'Accounting',
      category: 'CA',
      level: 'Foundation',
      scheme: 'New Scheme 2024+',
      description: 'Accounting process, bank reconciliation, inventory valuation, and final accounts.',
      order: 2,
      createdAt: DateTime(2026, 9, 6),
      updatedAt: DateTime(2026, 9, 6),
    ),
    ...
    Subject(
      ...
      group: 'Group 2',
      scheme: 'New Scheme 2024+',
      description: 'Cost sheet, standard costing, marginal costing, and budgetary control.',
      order: 6,
      createdAt: DateTime(2026, 9, 6),
      updatedAt: DateTime(2026, 9, 6),
    ),
    Subject(
      ...
      group: 'Group 2',
      scheme: 'New Scheme 2024+',
      description: 'Standards on Auditing (SAs), audit evidence, risk assessment, and professional ethics.',
      order: 7,
      createdAt: DateTime(2026, 9, 6),
      updatedAt: DateTime(2026, 9, 6),
    ),
    Subject(
      ...
      group: 'Group 1',
      scheme: 'New Scheme 2024+',
      description: 'Indian Accounting Standards (Ind AS), business combinations, and consolidated financial statements.',
      order: 8,
      createdAt: DateTime(2026, 9, 6),
      updatedAt: DateTime(2026, 9, 6),
    ),
    Subject(
      ...
      group: 'Group 1',
      scheme: 'New Scheme 2024+',
      description: 'Portfolio management, security valuation, and international financial management.',
      order: 9,
      createdAt: DateTime(2026, 9, 6),
      updatedAt: DateTime(2026, 9, 6),
    ),
    Subject(
      ...
      group: 'Group 2',
      scheme: 'New Scheme 2024+',
      description: 'Advanced corporate taxation, transfer pricing, and international tax treaties.',
      order: 10,
      createdAt: DateTime(2026, 9, 6),
      updatedAt: DateTime(2026, 9, 6),
    ),
    Subject(
      ...
      group: 'Group 2',
      scheme: 'New Scheme 2024+',
      description: 'GST Acts, Customs Act, and Foreign Trade Policy comprehensive notes.',
      order: 11,
      createdAt: DateTime(2026, 9, 6),
      updatedAt: DateTime(2026, 9, 6),
    ),
